...
class FAQs(Scene):
    def construct(self):
        ...
        faq_list = [
            ...
            ("部費や費用はかかりますか？", "同好会としての会費はありません。\nただし、活動において役にたつ各種サービスや資料を購入する際は\n自己負担でお願いします。"),
            ("プログラミング以外のITスキルも学べますか？", "もちろんです！\nプログラムの自作以外にもExcelやWordなどのソフトの使い方\n多様なテーマで自由に交流しています。"),
            ("現在のメンバーは何人ですか？", "現在のメンバーは2年生 1人、3年生 2人、4年生 11人、６年生 1人\nの15名です。メンバーが増えてくれると嬉しいです！"),
            ("同好会とありますが、部活と異なる点はなんですか？","活動において同好会と部活の違いはありません。\n1年以上の活動と明確な活動実績によって部活に昇格できます。\n部活になると部室や部費を得ることができるようになるため、\n現在は部活になることを目標に活動しています。"),
        ]
        ...
        for question, answer in faq_list:
            ...
            self.wait(0.3)
            self.play(Create(answer_group), run_time=1.8)
            wait_time = len(answer) / 40
            self.wait(wait_time)
